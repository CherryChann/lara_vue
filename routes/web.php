...
Route::get("backend/user/register", 'AccessController@register'); // just to show prototype of register page
Route::get("backend/admin/dashboard", 'AccessController@dashboard'); // just to show prototype of admin dashboard
Route::get('/', function () {
    return view('welcome');
});
